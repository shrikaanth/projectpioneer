// Project Pioneer Construction - About Page JavaScript
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll(
        '.trust-card, .service-overview-card, .team-member, .reason-card'
    );
    ...
    // Staggered animation for elements in grids
    const grids = document.querySelectorAll('.trust-grid, .services-grid, .team-grid, .reasons-grid');
    grids.forEach(grid => {
        const cards = grid.querySelectorAll('.trust-card, .service-overview-card, .team-member, .reason-card');
...
window.addEventListener('scroll', () => {
    ...
    if (aboutHero) {
        ...
        const heroContent = aboutHero.querySelector('.hero-content');
        if (heroContent) {
...
// Count-up animation for stats (if you add any numeric stats later)
...
console.log('Page: About Us - Project Pioneer Construction');
...
const revealSections = document.querySelectorAll('.who-we-are, .trust-signals, .services-overview, .leadership, .why-choose');
